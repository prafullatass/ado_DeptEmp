...
namespace DepartmentEmployee
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
                ...
                // We must create an instance of the Repository class in order to use it's methods toC:\Users\prafu\workspace\ado\DepartmentEmployee\DepartmentEmployee\Model\Department.cs
